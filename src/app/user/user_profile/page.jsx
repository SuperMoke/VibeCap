...
export default function UserProfile() {
  ...
  const handleUpdateProfile = async () => {
    ...
    if (!validateContact(editedContact)) {
      toast.error(
    ...
    try {
      ...
      if (!userSnapshot.empty) {
        ...
        setContact(editedContact || contact);
        setIsEditing(false);
  ...
  const handleChangePassword = async () => {
    setShowPasswordConfirmation(false); // Close dialog after confirmation
    try {
      const auth = getAuth();
            ...
            <div className="container mx-auto">
              ...
              <div className="flex flex-wrap justify-center gap-6">
                ...
                <Card className="w-96 p-8">
                  ...
                  <Button
                    color="blue"
                    className="mt-8 w-full py-3 text-white transition-all duration-200 ease-in-out"
                    onClick={() => {
                      if (!validateContact(editedContact)) {
                        toast.error(
                          "Mobile number must be exactly 11 digits (Example: 09123456789)"
                  ...
                  <Typography
                    color="gray"
                    className="text-xl font-bold mb-8 mt-2  text-center" // Increased bottom margi
                  >
                    Change Password
                  </Typography>
                  <div className="flex flex-col space-y-6">
